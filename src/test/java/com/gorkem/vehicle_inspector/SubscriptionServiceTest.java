...
class SubscriptionServiceTest {
    ...
    private static final LocalDateTime NEXT_MONTH =
            LocalDateTime.of(
                    2026,
                    10,
                    1,
    ...
    void freeUserFirstMonthlyAnalysisIsAllowed() {
        ...
        assertDoesNotThrow(
                () -> service
                        .validatePersonalMonthlyAnalysisLimit(
                                user,
                                NOW
                        )
        );
    ...
    void businessSharedMonthlyLimitIsOneHundred() {
        ...
        assertDoesNotThrow(
                () -> service
                        .validateBusinessMonthlyAnalysisLimit(
                                business,
                                NOW
                        )
        );
    ...
    void freeVehicleLimitIsOne() {
        ...
        when(
                vehicles.countByUserIdAndArchivedFalse(
                        1L
                )
        ).thenReturn(1L);
